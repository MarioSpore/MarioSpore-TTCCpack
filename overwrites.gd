...
# music
	...
	var _sbfactory = preload("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/SB_factory.ogg")
	installer.take_over_path("res://audio/music/CHQ_FACT_bg.ogg")
	var _sbfactory_encntr = preload("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/SB_factory_encntr.ogg")
