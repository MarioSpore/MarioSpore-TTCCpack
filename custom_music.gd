...
# music
	#bossbot
	print("Hello from custom_music.gd")
	var club_resource = load("res://scenes/game_floor/department_floors/rooms_boss.tres")
	club_resource.background_music.clear()
	club_resource.background_music.append_array([
	load("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/BB_club_silver.ogg"),
	load("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/BB_club_gold.ogg"),
	load("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/BB_club_diamond.ogg")
])
	club_resource.battle_music = load("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/BB_club_gold_encntr.ogg")
	ResourceSaver.save(club_resource, "res://scenes/game_floor/department_floors/rooms_boss.tres")
...
func on_battle_spawned(battle : BattleNode) -> void:
	if battle.override_intro:
		match battle.override_intro.get_class():
			...
			MoleCogIntro:
				battle.override_intro.override_music = load("res://mods-unpacked/MarioSpore-TTCCpack/overwrites/audio/music/Instance_rainmaker_battle_empty.ogg")
